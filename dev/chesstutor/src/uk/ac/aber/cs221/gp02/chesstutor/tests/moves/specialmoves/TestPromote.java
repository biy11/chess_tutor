/*
 * @(#) TestPromote.java 0.2 2023/05/05
 *
...
/**
 * These unit tests for the Promote class, it first makes sure a pawn can promote. Then
 * it will test if any piece can promote, then if a pawn can promote at any place on the
 * board
 *
 * @author Thomas [tpr3]
