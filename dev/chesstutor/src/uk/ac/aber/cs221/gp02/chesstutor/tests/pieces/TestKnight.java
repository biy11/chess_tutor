/*
 * @(#) TestKnight.java 0.6 2023/05/05
 *
...
/**
 * The JUnit tests for the Knight piece. These tests include the movement of the knight,
 * the capture of other pieces, and checking the king
 *
 * @author Lance [lvs1]
...
public class TestKnight {
    ...
    */
   private void testMovePiece(Square[][] board, Player p, int row, int col){
      p.addTakenPieces(board[3][3].getPiece());
