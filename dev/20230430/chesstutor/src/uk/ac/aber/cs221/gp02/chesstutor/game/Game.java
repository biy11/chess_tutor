...
public class Game { //Marks the class as an XML element
    ...
    * <p></p>
    * Sets turn to WHITE and roundCount to 1
    */
   public Game() {
      board = new Board();
      turn = Color.WHITE;
      roundCount = 1; //first move is round one
   ...
   public void setSaveDirectory(String saveDirectory) {
      ...
      if(roundCount > 1) GameSaveManager.moveTempFiles(saveDirectory);
   }
}
