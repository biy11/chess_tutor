/*
 * @(#) TestBishop.java 0.5 2023/05/05
 *
...
/**
 * A JUnit test class for the bishop. The tests for the bishop involve the movement, capture of other pieces,
 * and checking
 *
 * @author Lance [lvs1]
 ...
 * @version 0.5 removed unused Method createCheckBoard
 */
public class TestBishop {
    ...
    * @return out as either False or True
    */
    ...
    * Bishops are placed to have no valid moves
    * @return Board object
    */
