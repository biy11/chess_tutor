...
/**
 * A JUnit test class for the king. The tests for the king involve the restriction of movement,
 * capture of other pieces
 *
 * @author Lance [lvs1]
...
public class TestKing {
    ...
    */
   private void testMovePiece(Square[][] board, Player p){
      p.addTakenPieces(board[2][5].getPiece());
   ...
   public void testCapture(){
      ...
      testMovePiece(obj, p1); // king captures rook
   }
