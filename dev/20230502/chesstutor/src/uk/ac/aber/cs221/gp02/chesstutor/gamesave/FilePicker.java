...
public class FilePicker {
    ...
    /**
     * Opens the directory picker and returns the directory the user picks, or null if a folder is not picked
     * This pauses either the javafx thread, the main thread, or both, until a folder is picked
