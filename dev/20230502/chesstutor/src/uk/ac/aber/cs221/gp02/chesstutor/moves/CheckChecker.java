/*
 * @(#) CheckChecker.java 0.9 2023/03/09
 *
...
public class CheckChecker {
    ...
    * @param returnArray The array of moves
    */
   public static void inDangerChecker(Board board, int x, int y, Color attackingColor, List<int[]> returnArray) {
      ...
      for(int[] currentKingMove:returnArray){
         ...
         boardArray[currentKingMove[0]][currentKingMove[1]] = boardArray[x][y];
         boardArray[x][y] = new Square();
         ...
         boardArray[x][y] = boardArray[currentKingMove[0]][currentKingMove[1]];
