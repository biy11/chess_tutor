...
public class Board {
   ...
   public void boardResetForCheckTest(){
      for (int i = 0; i <= 7; i++) {
         for (int j = 0; j <= 7; j++) {
      ...
      boardArray[6][3] = new Square(new King(Color.BLACK));
      boardArray[5][6] = new Square(new Rook(Color.BLACK));
      boardArray[5][5] = new Square(new Knight(Color.BLACK));
   }
