...
public class TestRook {
   ...
   public void testCapture(){
      ...
      assertTrue( wRook1.getPossibleMoves(board, wRook1, 7,0).size() == 14 );
      ...
      assertTrue( bRook2.getPossibleMoves(board, bRook2, 0,7).size() == 14 );
   ...
   public void testMove(){
      ...
      assertTrue( wRook.getPossibleMoves(board, wRook, 7,0).size() == 13 );
      ...
      assertTrue( bRook.getPossibleMoves(board, bRook, 0,7).size() == 12 );
   }
