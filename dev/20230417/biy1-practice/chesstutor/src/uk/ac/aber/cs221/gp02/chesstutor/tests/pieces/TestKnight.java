...
public class TestKnight {
   ...
   public void testNoValidMoves(){
      ...
      assertTrue(obj[0][1].getPiece().getValidMoves(board, obj[0][1].getPiece(), 0, 1).isEmpty());
      assertTrue(obj[0][6].getPiece().getValidMoves(board, obj[0][6].getPiece(), 0, 6).isEmpty());
      assertTrue(obj[7][1].getPiece().getValidMoves(board, obj[7][1].getPiece(), 7, 1).isEmpty());
      assertTrue(obj[7][6].getPiece().getValidMoves(board, obj[7][6].getPiece(), 7, 6).isEmpty());
   ...
   public void testCapture(){
      ...
      assertTrue( findValidMoves(wKnight1.getValidMoves(board, wKnight1, 4,5),3,3) );
      assertEquals( 8, wKnight1.getValidMoves(board, wKnight1, 4,5).size());
      ...
      assertTrue( findValidMoves(bKnight1.getValidMoves(board, bKnight1, 5,2),3,3) );
      assertEquals( 8, bKnight1.getValidMoves(board, bKnight1, 5,2).size());
   ...
   public void testMove(){
      ...
      assertEquals( 8, wKnight.getValidMoves(board, wKnight, 5,4).size());
      assertTrue( findValidMoves(wKnight.getValidMoves(board, wKnight, 5,4),3,3) );
      assertTrue( findValidMoves(wKnight.getValidMoves(board, wKnight, 5,4),4,2) );
      assertTrue( findValidMoves(wKnight.getValidMoves(board, wKnight, 5,4),6,2) );
      assertTrue( findValidMoves(wKnight.getValidMoves(board, wKnight, 5,4),7,3) );
      assertTrue( findValidMoves(wKnight.getValidMoves(board, wKnight, 5,4),7,5) );
      assertTrue( findValidMoves(wKnight.getValidMoves(board, wKnight, 5,4),6,6) );
      assertTrue( findValidMoves(wKnight.getValidMoves(board, wKnight, 5,4),4,6) );
      assertTrue( findValidMoves(wKnight.getValidMoves(board, wKnight, 5,4),3,5) );

      // Test Black possible moves
      assertEquals( 7, bKnight.getValidMoves(board, bKnight, 2,5).size());
      assertFalse( findValidMoves(bKnight.getValidMoves(board, bKnight, 2,5),0,4) );
      assertTrue( findValidMoves(bKnight.getValidMoves(board, bKnight, 2,5),1,3) );
      assertTrue( findValidMoves(bKnight.getValidMoves(board, bKnight, 2,5),3,3) );
      assertTrue( findValidMoves(bKnight.getValidMoves(board, bKnight, 2,5),4,4) );
      assertTrue( findValidMoves(bKnight.getValidMoves(board, bKnight, 2,5),4,6) );
      assertTrue( findValidMoves(bKnight.getValidMoves(board, bKnight, 2,5),3,7) );
      assertTrue( findValidMoves(bKnight.getValidMoves(board, bKnight, 2,5),1,7) );
      assertTrue( findValidMoves(bKnight.getValidMoves(board, bKnight, 2,5),0,6) );


   }

   /**
    * Test knights for checking kings
    */
   @Test
   public void testCheck(){
      ...
      Player p2 = new Player(Color.BLACK, "Micah");

      Piece bKing = obj[0][4].getPiece();
      Piece bKnight = obj[0][2].getPiece();
      Piece wKnight = obj[3][5].getPiece();

      // White move first - check then move
      assertTrue( findValidMoves(wKnight.getValidMoves(board, wKnight, 3,5),2,3) );
      assertEquals( 8, wKnight.getValidMoves(board, wKnight, 3,5).size() );
      testMovePiece(obj, p1, 3,5,2,3);

      // Black King is in check - either knight takes knight or king dodges
      assertEquals( 1, bKnight.getValidMoves(board, bKnight, 0,2).size() );
      assertTrue( findValidMoves(bKnight.getValidMoves(board,bKnight,0,2),2,3) );

      assertEquals( 4, bKing.getValidMoves(board, bKing, 0,4).size() );
      assertTrue( findValidMoves(bKing.getValidMoves(board, bKing, 0,4),0,3) );
      assertTrue( findValidMoves(bKing.getValidMoves(board, bKing, 0,4),1,3) );
      assertTrue( findValidMoves(bKing.getValidMoves(board, bKing, 0,4),1,4) );
      assertTrue( findValidMoves(bKing.getValidMoves(board, bKing, 0,4),0,5) );
      assertFalse( findValidMoves(bKing.getValidMoves(board, bKing, 0,4),1,5) );
