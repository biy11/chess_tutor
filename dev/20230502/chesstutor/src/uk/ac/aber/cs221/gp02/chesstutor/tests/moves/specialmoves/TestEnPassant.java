...
//      List<int[]> afafaga = getMoves(game.getBoard(), game.getBoard().getBoardArray()[6][4].getPiece(), 6, 0);
//      boolean sgssgs = afafaga.isEmpty();
